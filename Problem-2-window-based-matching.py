...
# Create results directory for Problem 2 if it doesn't exist
results_dir = 'result-problem-2'
...
right_img_path = 'images/aloe/Aloe/Aloe_right_1.png'
disparity_range = 64
kernel_size = 3

# Display and process results for L1
...
# Display and process results for L2
